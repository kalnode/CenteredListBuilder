...
function Header(props) {
    return (
        <>
            ...
            <ul id="navigation">
                <li><NavLink exact="true" className={({ isActive }) => isActive? "is-active": ''} to='/about'>About</NavLink></li>
                <li><NavLink className={({ isActive }) => isActive? "is-active": ''} to='/tool'>Make a List</NavLink></li>
            </ul>

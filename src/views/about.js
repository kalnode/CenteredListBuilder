        ...
        <div id="about" className="inner">
            ...
            <section id="intro">
                ...
                <div className="cta" style={{marginTop: "8em"}}>
                    <Link className='buttonCTA' to='/tool'>Make a List!</Link>
                </div>
            ...
            <section className="content">
                ...
                <div className="cta">
                    ...
                    <Link  className='buttonCTA' to='/tool'>Start here</Link>
                </div>
            </section>
        </div>
    )
